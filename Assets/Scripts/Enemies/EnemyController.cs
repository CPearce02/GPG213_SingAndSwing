...
namespace Enemies
{
    public class EnemyController : Attackable, IAttackable
    {
        ...
        [SerializeField] private Movement movementType;
        ...
        [Header("Trail")]
        [SerializeField] private TrailHandler trail = new();
        ...
        private void Flee()
        {
            ...
            if (HasAttacked)
            {
                ...
                rb.AddForce(directionOfTravel * (-1 * fleeSpeed * Time.deltaTime));
